...
module.exports = {
  ...
  goToBusinessGoalHistory: ({ driver }) => driver.get(`${PROXY_URL}/business-goals/history/`),
  goToBusinessGoalPlan: ({ driver }) => driver.get(`${PROXY_URL}/business-goals/plan`),
  goToDetailedPlanHome: ({ driver }) => driver.get(`${PROXY_URL}/detailed-plan`)
};
