...
module.exports = {
  ...
  goToNewBusinessGoalHome: ({ driver }) => driver.get(`${PROXY_URL}/business-goals/`),
  goToNewBusinessGoalDrafts: ({ driver }) => driver.get(`${PROXY_URL}/business-goals/drafts/`),
  ...
  goToNewBusinessGoalHistory: ({ driver }) => driver.get(`${PROXY_URL}/business-goals/history/`),
  goToNewBusinessGoalPlan: ({ driver }) => driver.get(`${PROXY_URL}/business-goals/plan`),
};
