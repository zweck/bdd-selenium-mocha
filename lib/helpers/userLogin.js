/**
 * @module helper/userLogin
 */
const { By } = require('selenium-webdriver');
const { goToNewBusinessGoalHome } = require('../helpers/navigators');
const { elementIsPresent } = require('../helpers/locators');
const error = require('../error');

/**
 * Sets the SSO identity to 'admin' when proxying requests
...
async function logInAsAdminUser({ proxy, driver }) {
  ...
  await goToNewBusinessGoalHome({ driver });
